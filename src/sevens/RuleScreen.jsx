        ...
        >
          <div className="sevensRulePanel">
            <header className="sevensRuleHeader">
              ...
              <p>
                すべてのカードを出し切り、7回戦の合計得点でトップを目指そう
              </p>
            </header>
            ...
            <div className="sevensRuleList">
              <article className="sevensRuleItem">
                ...
                <div>
                  ...
                  <p>
                    各マークの7を中心に、6・8、5・9の順番でカードを並べていきます。
                  </p>
                </div>
              </article>
              ...
              <article className="sevensRuleItem">
                ...
                <div>
                  ...
                  <p>
                    カードを選択して「出す」ボタンを押すか、カードをダブルタップすると出せます。
                  </p>
                </div>
              </article>
              ...
              <article className="sevensRuleItem">
                ...
                <div>
                  ...
                  <p>
                    パスは1人3回まで使えます。残り回数は画面のボタンや相手の表示から確認できます。
                  </p>
                </div>
              </article>
              ...
              <article className="sevensRuleItem">
                ...
                <div>
                  ...
                  <p>
                    3回パスした後にカードを出せなくなるとバーストし、手札をすべて盤面へ出します。
                  </p>
                </div>
              </article>
              ...
              <article className="sevensRuleItem">
                ...
                <div>
                  ...
                  <p>
                    最初の1手には制限時間がありません。2手目以降は3秒以内にカードを選んでください。
                  </p>
                </div>
              </article>
              ...
              <article className="sevensRuleItem">
                ...
                <div>
                  ...
                  <p>
                    各回戦の順位や生存状況によって得点が加算されます。7回戦終了時の最高得点者がチャンピオンです。
                  </p>
                </div>
              </article>
            </div>
